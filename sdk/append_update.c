 ...
 * \brief  example program for the append online update
 */

#include "xil_io.h"

static void ledControl_update1() __attribute__((used, section(".update_1")));

static uint32_t leds_val = 0x0f;

static void ledControl_update1() {
...
static void ledControl() {
	...
	leds_val = (leds_val == 0x0f) ? 0xa0 : 0x0f;
}
